...
public class ApiUser {
    ...
    //email, state of origin, gender, phone number, school, faculty, department, level
    ...
    public ApiUser(String userName, String password, String email,
                   String stateOfOrigin, String gender, String phoneNumber,
                   String school, String faculty, String department, String level) {
        this.userName = userName;
        this.password = password;
        this.email = email;
